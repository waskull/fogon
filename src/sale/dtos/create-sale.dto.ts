import { IsNumber, Min,ArrayMinSize, ValidateNested, IsPositive, IsNotEmpty, IsArray, ArrayNotEmpty, IsOptional, IsString, IsEnum, MinLength, IsDateString, IsBoolean } from "class-validator";
...
export class CreateSaleOrderDto{
    ...
    @IsNumber()
    @IsPositive({message:'Debes proveer una mesa valida'})
    table:number;
}